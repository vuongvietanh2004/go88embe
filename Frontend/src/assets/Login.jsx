        ...
        <form onSubmit={handleSubmit(onSubmit)} method="dialog">
         ...
         {/* Email */}
            ...
            <div className='flex justify-around mt-4'>
                ...
                <button className='bg-red-400 text-white rounded-md px-3 py-1 hover:bg-green-200 duration-200'>Login</button>
                <p>Not registered? <Link to="/signup"
                 className='underline text-sky-400 cursor-pointer'>Signup</Link>{""}
                 </p>
            </div>
            </form>
            </div>
